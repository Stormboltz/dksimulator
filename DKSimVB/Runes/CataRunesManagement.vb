...
Friend Partial Class runes
	...
	Function CataGetNextFrost(T As Long) As Long
		Dim bArray As new ArrayList
	...
	Function CataGetNextBloodCD(T As Long) As Long
		Dim bArray As new ArrayList
	...
	Function CataUseDeathBlood(T As Long,Death As Boolean) As Boolean
		...
		Else
			debug.Print ("Error in CataUseDeathBlood")
		End If
	End Function
	...
	Function CataUseBlood(T As Long,Death As Boolean) As Boolean
	...
	Function CataUseFrost(T As Long,Death As Boolean) As Boolean
	...
	Function CataUseUnholy(T As Long,Death As Boolean) As Boolean
		...
		If FrostRunes.Available And FrostRunes.death Then
			...
			return true
		End If
		debug.Print ("ERROR Unholy RUNE")
	End Function
	Function CataUseFU(T As Long,Death As Boolean) As Boolean
		If UnholyRunes.Available And FrostRunes.Available Then
			UnholyRunes.Use(T,Death)
			FrostRunes.Use(T,Death)
			return true
